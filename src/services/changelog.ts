...
export const LATEST_CHANGES: { title: string, items: ChangeItem[] } = {
  ...
  items: [
    { icon: 'mdi-format-list-group', text: 'قائمة موحّدة بلا تشتيت: قسم «حسابي» واحد لكل الأدوار (المحفظة، الاستبيانات إنشاءً ومشاركةً، صفحتك التعريفية، المساعد، التحليلات الموحّدة) وتحته «مساحة الدور» النشط فقط', to: 'unified-hub' },
